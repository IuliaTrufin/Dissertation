...
namespace WebApplication2.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(InvoiceManagerContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Product>> PutProduct(int id, ProductDTO productDTO)
        {
            ...
            product.ProfileImage = productDTO.ProfileImage;
        ...
        public async Task<ActionResult<Product>> PostProduct(ProductDTO productDTO)
        {
          if (_context.Products == null)
          {
              return Problem("Entity set 'InvoiceManagerContext.Products'  is null.");
          }
