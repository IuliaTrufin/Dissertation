...
namespace InvoiceManagerTestProject
{
    public class MyProfileTests
    {
        public void GeneralValidations()
        {
            ...
            driver.Navigate().GoToUrl("http://localhost:3000/myprofile");
            Thread.Sleep(3000);
            ...
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[21]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[22]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[23]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[24]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[25]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[26]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[27]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[28]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[29]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[30]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[31]")) != null);
            Assert.True(driver.FindElement(By.XPath("//*[@id=\"root\"]/div[2]/main/div/div/div[32]")) != null);
            driver.Quit();
        }
    }
}
